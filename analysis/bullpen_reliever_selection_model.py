...
def split(gs):
 tr=[];va=[];te=[]
 for g in gs:
  (tr if g['date']<=date(2025,7,31) else va if g['date']<=date(2025,8,31) else te).append(g)
 return tr,va,te
