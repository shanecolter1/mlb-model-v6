...
def main():
    ...
    m=read(a.master)
    need=['game_date','away_team_code','home_team_code','dk_total_open_total','inning2_total_runs']; miss=[c for c in need if c not in m.columns]
    ...
    idx=gi[['game_id','game_date','away_team_id','home_team_id','away_team_code','home_team_code']].copy(); joined=m.merge(idx,on=['game_date','away_team_code','home_team_code'],how='inner',validate='one_to_one')
    ...
    for bat_side,pit_side,team_id_col in [('away','home','away_team_id'),('home','away','home_team_id')]:
        base=joined[['game_id','game_date','away_team_code','home_team_code','away_team_id','home_team_id','dk_total_open_total','inning2_total_runs']].copy()
    ...
    keys=['game_id','game_date','away_team_code','home_team_code','dk_total_open_total','inning2_total_runs']
